  ...
  const [expenseData, setExpenseData] = useState([]);
    ...
    const deleteExpense = async (id) =>{
      ...
      fetchExpenseDetails();
        ...
        console.error("Error deleting Expense details",error.response?.data?.message || error.message)
      }
    };
  ...
  return (
    <DashboardLayout activeMenu="Expense">
      <div className='my-5 mx-auto'>
        ...
        <ExpenseList
          transactions={expenseData} onDelete={(expense) => setOpenDeleteAlert({ show: true, data: expense })}
